...
export const I18N_DICTIONARY = {
  en: {
    ...
    syncGps: 'Sync GPS',
    gpsCalibrating: 'Calibrating GPS...',
    gpsCalibratedSuccess: 'GPS Calibrated Successfully',
    ...
    ratingLockedNotice: 'Rating will unlock once work is completed and payment is processed.',
    ratingLockedBadge: 'Rating Locked (Post-Payment Only)',
    rateAndReviewWorker: 'Rate & Review Worker',
    verifiedSettlementRequired: 'Verified Settlement Required: You can submit a rating and review once your service booking is completed and payment is settled.',
  ...
  hi: {
    ...
    syncGps: 'GPS सिंक करें',
    gpsCalibrating: 'GPS कैलिब्रेट हो रहा है...',
    gpsCalibratedSuccess: 'GPS सफलतापूर्वक कैलिब्रेट हुआ',
    ...
    ratingLockedNotice: 'काम पूरा होने और भुगतान संसाधित होने के बाद रेटिंग अनलॉक होगी।',
    ratingLockedBadge: 'रेटिंग लॉक है (केवल भुगतान के बाद)',
    rateAndReviewWorker: 'कारीगर को रेटिंग और समीक्षा दें',
    verifiedSettlementRequired: 'सत्यापित भुगतान आवश्यक: सेवा पूरी होने और UPI भुगतान पूरा होने के बाद ही आप रेटिंग दे सकते हैं।',
  ...
  mr: {
    ...
    syncGps: 'GPS सिंक करा',
    gpsCalibrating: 'GPS कॅलिब्रेट होत आहे...',
    gpsCalibratedSuccess: 'GPS यशस्वीरित्या कॅलिब्रेट झाले',
    ...
    ratingLockedNotice: 'काम पूर्ण झाल्यावर आणि पेमेंट प्रक्रिया पूर्ण झाल्यावर रेटिंग अनलॉक होईल.',
    ratingLockedBadge: 'रेटिंग लॉक आहे (केवळ पेमेंट्स नंतर)',
    rateAndReviewWorker: 'कामगाराला रेटिंग व अभिप्राय द्या',
    verifiedSettlementRequired: 'पडताळणी झालेले पेमेंट आवश्यक: सेवा पूर्ण झाल्यावर आणि UPI सेटलमेंट झाल्यावरच आपण रेटिंग देऊ शकता.',
