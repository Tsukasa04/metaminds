...
import {
  ...
  ArrowRight, RefreshCw, Lock, Hourglass, CheckCircle2, Star
} from 'lucide-react';
      ...
      <div className="relative min-h-screen bg-[#F6F4EE] text-black pt-20 pb-16 px-4 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-lg border-2 border-black bg-amber-300 hover:bg-amber-200 text-xs font-black text-black shadow-[2px_2px_0px_0px_#000] tracking-wide flex items-center gap-1.5 cursor-pointer active:translate-x-[1px] active:translate-y-[1px]"
          >
            <Star size={13} className="fill-black" /> {t('rateAndReviewWorker')}
          </button>
        </div>
